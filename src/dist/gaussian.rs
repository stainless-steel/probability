...
impl Distribution<f64> for Gaussian {
    ...
    fn inv_cdf(&self, p: f64) -> f64 {
        ...
        const B: [f64, ..8] = [
            1.0000000000000000000e+0, 4.2313330701600911252e+1,
        ...
        const D: [f64, ..8] = [
            1.00000000000000000000e+0, 2.05319162663775882187e+0,
        ...
        const F: [f64, ..8] = [
            1.00000000000000000000e+0, 5.99832206555887937690e-1,
