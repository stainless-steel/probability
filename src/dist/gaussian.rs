...
impl Distribution<f64> for Gaussian {
    ...
    fn inv_cdf(&self, p: f64) -> f64 {
        ...
        const A: [f64, ..8] = [3.3871328727963666080,
        ...
        const B: [f64, ..8] = [1.0000000000000000000,
        ...
        const C: [f64, ..8] = [1.42343711074968357734,
        ...
        const D: [f64, ..8] = [1.00000000000000000000,
        ...
        const E: [f64, ..8] = [6.65790464350110377720,
        ...
        const F: [f64, ..8] = [1.00000000000000000000,
